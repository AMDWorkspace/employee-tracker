                ...
                function (err, results, fields) {
                    ...
                    inquirer
                        ...
                        .then((data) => {
                            ...
                            // whether or not based on users input if the employee is a manager or not 
                            let manager_confirm;
                            ...
                            if (!data.mngt_pick) {
                                manager_id = null;
                                // else Create a loop of the manager arr in order to compare the users answer
                            } else {
